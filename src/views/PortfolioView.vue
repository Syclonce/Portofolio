    ...
    <article data-page="about">
      <header>
        <div
          ...
          <div class="h-[10px]"></div> <!-- Menambahkan jarak -->
          <div class="h-[2px] w-12 bg-amber-300 md:w-60 aos-init aos-animate"></div>
          <div class="h-[10px]"></div> <!-- Menambahkan jarak -->
            ...
            <div v-for="item in items" :key="item.id">
              <div
                ...
                <div class="flex h-12 w-12 items-center justify-center p-0 h-full w-full lg:p-0 zoom-in">
                  <img alt="HTML" loading="lazy" decoding="async" data-nimg="1" class="drop-shadow-xl rounded rounded-xl image-container"
...
.item-card {
  height: 100%; /* Menetapkan tinggi tetap untuk semua elemen */
}
.item-card:hover {
