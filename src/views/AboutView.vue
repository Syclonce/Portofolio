    ...
    <article data-page="about">
      ...
      <section
        ...
        <div class="flex justify-center">
          <img class="rounded-full mb-4 fadein-up w-10/12 md:w-[390px] h-auto md:h-[350px] rounded-full border-4 border-amber-200 pict"  src="/img/icon.png" >
        </div>
        <div class="md:w-7/12">
          <p class="mb-3 md:mb-7 fadein-left fadeins-1">
            &nbsp; &nbsp; &nbsp; Hi everyone! My name is Scyclonce. I'm a web developer from java, West Java. I
...
export default {
  ...
  methods: {
    fetchData() {
      ...
      axios.get('http://localhost:3000/api/tools')
        .then(response => {
